...
# ── POST /poll/<token>/vote ───────────────────────────────
@vote_bp.route("/poll/<string:token>/vote",
               methods=["POST"])
